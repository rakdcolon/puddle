 ...
 *   node scripts/import-puzzle.mjs puzzles/my-puzzle.json
 *
...
// ─── Load app/.env.local ──────────────────────────────────────────────────────
const envPath = join(new URL('.', import.meta.url).pathname, '..', 'app', '.env.local')
try {
...
if (!url || !key) {
  ...
  console.error('Set them in app/.env.local or export them in your shell.')
  process.exit(1)
}
